...
/* harmony import */ var _api_pecasdata_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../api/pecasdata.service */ "./src/app/api/pecasdata.service.ts");
...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(storage, plt, router, pecasdata) {
        var _this = this;
    ...
    AuthenticationService.prototype.login = function (user) {
        ...
        return this.storage.set(TOKEN_KEY, user["user"].name).then(function () {
            _this.authenticationState.next(true);
            _this.router.navigate(['/entrar/user']);
        });
    };
    AuthenticationService.prototype.logout = function () {
        var _this = this;
        return this.storage.remove(TOKEN_KEY).then(function () {
            _this.pecasdata.logout();
    ...
    AuthenticationService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_storage__WEBPACK_IMPORTED_MODULE_3__["Storage"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["Platform"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"], _api_pecasdata_service__WEBPACK_IMPORTED_MODULE_6__["PecasdataService"]])
